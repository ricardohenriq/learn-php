...
class TForm
{
	...
	//$fields é necessario para quando tivermos de retornar os 
	//os dados enviados pelo formulario
	 ...
	 * (como se pre-preenchessemos alguns 
	 * campos do formulario com as propriedades
